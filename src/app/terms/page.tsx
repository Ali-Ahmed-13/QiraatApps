...
export const metadata: Metadata = {
  title: 'شروط الخدمة واتفاقية إخلاء المسؤولية | منصة تِيجَان',
  description: 'اطلع على شروط استخدام منصة تِيجَان وتراخيص التطبيقات وحقوق الملكية الفكرية واتفاقية إخلاء المسؤولية القانونية الخاصة بالتطبيقات والتلاوات الصوتية.',
};
      ...
      <div className="flex flex-col gap-8 bg-card dark:bg-[#0f1422] border border-border dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-sm leading-relaxed text-justify">
        ...
        <section className="flex flex-col gap-3">
          <div className="flex items-center gap-2.5 text-amber-800 dark:text-emerald-400">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-[#1E1E1E] dark:text-slate-100">1. قبول الشروط والأحكام</h2>
          </div>
          <p className="text-xs sm:text-sm text-slate-605 dark:text-slate-350 leading-relaxed pr-7">
            باستخدامكم لمنصة تِيجَان أو تنزيل أي من التطبيقات المتاحة عليها، فإنكم تقرون بقبولكم التام وغير المشروط لكافة البنود والشروط الواردة في هذه الاتفاقية. إذا كنتم لا توافقون على أي جزء من هذه الشروط، يرجى التوقف فوراً عن استخدام المنصة وتنزيل تطبيقاتها.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-3">
          <div className="flex items-center gap-2.5 text-amber-800 dark:text-emerald-400">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-[#1E1E1E] dark:text-slate-100">2. ترخيص استخدام البرمجيات</h2>
          </div>
          <p className="text-xs sm:text-sm text-slate-605 dark:text-slate-350 leading-relaxed pr-7">
          ...
          <div className="bg-card dark:bg-slate-900/60 border border-border dark:border-slate-800/60 rounded-2xl p-4 mr-7 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
            <p className="font-bold mb-2 text-[#1E1E1E] dark:text-slate-300">يُمنع منعاً باتاً القيام بالآتي:</p>
        ...
        <section id="disclaimer" className="flex flex-col gap-3 scroll-mt-24">
          <div className="flex items-center gap-2.5 text-amber-800 dark:text-emerald-400">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-[#1E1E1E] dark:text-slate-100">3. اتفاقية إخلاء المسؤولية القانونية</h2>
          </div>
        ...
        <section id="copyright" className="flex flex-col gap-3 scroll-mt-24">
          <div className="flex items-center gap-2.5 text-amber-800 dark:text-emerald-400">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-[#1E1E1E] dark:text-slate-100">4. حقوق الملكية الفكرية والنشر</h2>
          </div>
          <p className="text-xs sm:text-sm text-slate-650 dark:text-slate-350 leading-relaxed pr-7">
        ...
        <section className="flex flex-col gap-3">
          <div className="flex items-center gap-2.5 text-amber-800 dark:text-emerald-400">
            ...
            <h2 className="text-lg sm:text-xl font-bold text-[#1E1E1E] dark:text-slate-100">5. التحديثات والتعديلات على الاتفاقية</h2>
          </div>
          <p className="text-xs sm:text-sm text-slate-605 dark:text-slate-350 leading-relaxed pr-7">
